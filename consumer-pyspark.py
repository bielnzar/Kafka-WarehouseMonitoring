...
from pyspark.sql.functions import col, from_json, current_timestamp, lit, concat_ws
...
try:
    ...
    # Create status column for critical conditions
    ...
    print(f"Error running Spark application: {e}")
finally:
    spark.stop()